...
class MySQLParser extends Parser<SQLQueryTree> {
	...
	public function parse(string $sql): SQLQueryTree {
	...
	protected function _treeify_parsed_query(array<mixed, mixed> $node): SQLQueryTree {
		$M = Map{};
		foreach($node as $k=>$v) {
